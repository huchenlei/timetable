    ...
    function SearchBarComponent(courseService) {
        ...
        this.fetchCourse = function (query) {
            ...
            return _this.courseService
                ...
                result.forEach(function (c) { return c.code = c.code.substr(0, 6); });
...
var Day = (function () {
    function Day() {
        this.morning = false; // 8-12
        this.noon = false; // 12-1
        this.highTea = false; // 1-3
        this.afternoon = false; // 3-6
        this.evening = false; // 6-10
        this.any = true;
        this.no = false;
    }
    return Day;
...
var CourseService = (function () {
    ...
    CourseService.prototype.fetchCourseBody = function (query, term) {
        var course_code = query;
